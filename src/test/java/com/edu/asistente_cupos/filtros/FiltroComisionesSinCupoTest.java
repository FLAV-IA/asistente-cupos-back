...
public class FiltroComisionesSinCupoTest {
    ...
    private FiltroAComisionesSinCupo filtro= new FiltroAComisionesSinCupo();
    @Test
    ...
    void testFiltrarComisionesSinCupo() {
        ...
        List<Comision> comisionesRestantes = resultado.get(0).getPeticionPorMaterias().get(0).getComisiones();
    ...
    private PeticionInscripcion crearPeticion(Estudiante estudiante, PeticionPorMateria... ppm) {
        return PeticionInscripcion.builder()
